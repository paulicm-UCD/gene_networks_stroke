###################################################################################################################
#This script has been modified from Jeremy Miller's "Meta-analyses of data 
#from two (or more) microarray data sets" tutorial with only minor additions made

#Miller's tutorial and related files (including the source of this file) can be found at: 
...
###Add in automatic hub gene export###
numModGenes = dim(datConn)[1]
numHubGenes = round(numModGenes*.05)
hubGenes = datConn[1:numHubGenes,1]
fn2 = paste(moduleColor, "_hubGenes.csv", sep = "")
write.table(hubGenes,file=fn2,sep=",",
